...
export default function Page() {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-blue-950 overflow-hidden">
        ...
        <div className="absolute top-3/4 left-7/8 w-52 h-52 bg-white/50 rounded-full filter blur-2xl opacity-60 animate-wave-slow"></div>        {/* يمكنك إضافة المزيد من الأشكال هنا بأنماط وتحريكات مختلفة */}
      ...
      <div className="space-y-4">
        ...
        <h1 className="text-6xl font-bold text-emerald-500">Forgot Password</h1>
